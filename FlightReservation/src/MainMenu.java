			...
			try {
				...
				if (input == null) {
					...
					case 2:
						...
						String seatInput = JOptionPane.showInputDialog(null, "Enter empty seat number: ", "Seat Info",
								JOptionPane.PLAIN_MESSAGE);
						if (seatInput == null) {
							break;
						}
					...
					default:
						JOptionPane.showMessageDialog(null, "Please enter the number of one of " + "the given options",
